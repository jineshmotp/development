...
import { CommercialFilterList, CommercialFilterListFun } from '../../Common/Constant/filterList';
import FilterValues from '../../Common/FilterValues';
import CommercialRightFilter from '../CommercialRightFilter';
import { styles } from './styles';

const CommericalFilterSheet = ({ showCommercialFilters, setShowCommercialFilters, globalSearch }: any) => {
  const initialData = {
    most_favourite: '',
    verified: '',
    approved_by_rera: '',
  ...
  // const [filterKey, setFilterKey] = useState(CommercialFilterList);
  const [filterKey, setFilterKey] = useState(CommercialFilterListFun(initialData));
  ...
  useEffect(() => {
    setFilterKey(CommercialFilterListFun(filterDetails));
...
export default memo(CommericalFilterSheet);
