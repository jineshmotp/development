...
const FavouriteCard: React.FC<Props> = ({ data, onPress, onPressFavourite }) => {
    ...
    <TouchableOpacity onPress={onPress} style={styles.container}>
      <RNView style={styles.topView}>
        ...
        <RNView style={styles.imgContainer}>
          ...
          {data?.property?.property_type !== 'Coliving' ? (
            <RNView style={styles.rightBottom}>
              <RNView style={styles.flexRow}>
                <RNView style={{ flexDirection: 'column', flex: 1 }}>
                ...
                <RNView style={{ flexDirection: 'column', marginLeft: 5, flex: 1 }}>
