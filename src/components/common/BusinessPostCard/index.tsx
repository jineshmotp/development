...
const BusinessPostCard: React.FC<Props> = ({
  data,
  onPress,
  onPressComment,
  srNumber,
      ...
      {hidePropertyUI ? (
        ...
        <RNView
          ...
          <PropertyActionHideModel
            data={selectedData?._id === data?.business?._id ? user_own_post_action_list : user_other_post_action_list}
...
export default React.memo(BusinessPostCard);
