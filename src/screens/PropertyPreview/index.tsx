...
import { CoWorkFLexi, isValidURL } from '@/constants/function/property.helper';
...
import PropertyOwnderDisplayDetails from '../../components/property/PropertyOwnderDisplayDetails';
...
const PropertyPreview = () => {
  ...
  const route = useRoute<RouteProp<RootStackParamList, 'POST_PROPERT_PREVIEW'>>();
