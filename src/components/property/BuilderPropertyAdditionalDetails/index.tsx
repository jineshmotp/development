...
const BuilderPropertyAdditionalDetails: React.FC<PropertyAreaProps> = ({ details }) => {
  // console.log('checking on details ====>>>>',JSON.stringify(details));checking on details ====>>>>
...
export default BuilderPropertyAdditionalDetails;
