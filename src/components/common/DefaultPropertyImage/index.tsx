...
const DefaultPropertyImage: React.FC<PropertyAreaProps> = ({
  details,
  goBack,
  url,
  index,
    ...
    <RNView>
      <ImageBackground
        ...
        <RNView style={styles.topView}>
          ...
          <TouchableOpacity onPress={handleRequestPhoto}>
                ...
                <RNView style={styles.pricingChild}>
                  <RNView
                    ...
                    <RNView
                      ...
                      {details?.business_id === null || details?.business_id === undefined ? (
