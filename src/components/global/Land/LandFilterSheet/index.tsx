...
import { LandFilterList } from '../../Common/Constant/filterList';
import FilterValues from '../../Common/FilterValues';
import LandRightFilter from '../LandRightFilter';
import { styles } from './styles';

const LandFilterSheet = ({ showLandFilters, setShowLandFilters, globalSearch }: any) => {
  const [filterKey, setFilterKey] = useState(LandFilterList);
                        ...
                        return (
                          <TouchableOpacity
                            ...
                            style={[
                              styles.subView,
                              {
                                borderBottomWidth: LandFilterList?.length === i + 1 ? 0 : 1,
...
export default memo(LandFilterSheet);
