...
export const activateItem = (item: any, propertyKey: any, array: any, setArray: any) => {
...
export const activateMultipleItems = (item: any, propertyKey: any, array: any, setArray: any) => {
  const shallowCopy = [...array];
