...
import { ColivingFilterList } from '@/components/global/Common/Constant/filterList';
...
import ColivingRightFilter from '@/components/global/Coliving/ColivingRightFilter';

const Coliving = ({
 showColivingFilters,
  setShowColivingFilters,
  globalSearch,
  initialData,
  clearFilters,
  setFilterDetails,
