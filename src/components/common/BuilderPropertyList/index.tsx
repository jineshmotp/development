...
const BuilderPropertyList: React.FC<Props> = ({ headerShow = true, userId, businessId }) => {
  ...
  const [getAllUserPropertyMutation] = useLazyGetUserPropertyQuery();
...
export default BuilderPropertyList;
