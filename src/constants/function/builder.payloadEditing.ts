export function ProperyListing_PayloadGenerator(payload: any) {
  if (payload.iwant === 'Sell' && payload.property_type === 'Residential') {
    let newpayload = {
      ...
      property_facing_array: payload.property_facing_array,
      property_area: isNaN(parseInt(payload.property_area)) ? 0 : parseInt(payload.property_area),
      property_area_max: isNaN(parseInt(payload.property_area_max)) ? 0 : parseInt(payload.property_area_max),
      ...
      state: payload.state,
      no_of_units: isNaN(parseInt(payload.no_of_units)) ? 0 : parseInt(payload.no_of_units),
      ...
      property_price_max: isNaN(parseInt(payload.property_price_max)) ? 0 : parseInt(payload.property_price_max),
      property_price_per_unit: isNaN(parseInt(payload.property_price_per_unit))
        ? 0
        : parseInt(payload.property_price_per_unit),
      property_price_per_unit_max: isNaN(parseInt(payload.property_price_per_unit_max))
        ? 0
        : parseInt(payload.property_price_per_unit_max),
      ...
      property_broucher: payload.property_broucher,
      property_layout: payload.property_layout,
    };
    ...
    // if (newpayload.property_broucher === '' || newpayload.property_broucher.length === 0) {
    //   delete newpayload.property_broucher;
    // }
    // if (newpayload.property_layout === '' || newpayload.property_layout.length === 0) {
    //   delete newpayload.property_layout;
    // }
