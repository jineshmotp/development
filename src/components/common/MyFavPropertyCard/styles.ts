...
export const styles = StyleSheet.create({
  ...
  flexRow: { flexDirection: 'row', marginTop: px(5) },
  transView: {
    padding: 3,
    borderWidth: 0.5,
    borderColor: 'gray',
  ...
  facingText: { fontSize: SIZES.small13, color: '#8F8F8F', fontWeight: '500' },
  facingText_facing: { fontSize: SIZES.small, color: '#8F8F8F', fontWeight: '500' },
});
