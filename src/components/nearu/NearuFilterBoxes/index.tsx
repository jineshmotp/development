...
import NearuDistanceSlider from '../NearuDistanceSlider';
import NearuRangeSlider from '../NearuRangeSlider';
import { styles } from './styles';

export const NearuDistanceFilter = ({ filterDetails, setFilterDetails }: any) => {
  return (
    <RNView style={styles.filterView}>
      <NearuDistanceSlider filterDetails={filterDetails} setFilterDetails={setFilterDetails} />
    </RNView>
  );
};

export const NearuRangeFilter = ({ filterDetails, setFilterDetails }: any) => {
  return (
    <RNView style={styles.filterView}>
      <NearuRangeSlider filterDetails={filterDetails} setFilterDetails={setFilterDetails} />
    </RNView>
  );
};
