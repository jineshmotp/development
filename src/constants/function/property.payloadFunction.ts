export function ProperyListing_PayloadGenerator(payload: any) {
  if (((payload.iwant === 'Sell' || payload.iwant === 'Investment Sharing') || payload.iwant === 'Investment Sharing') && payload.property_type === 'Residential') {
    let newpayload = {
      iwant: payload.iwant,
  ...
  if ((payload.iwant === 'Sell' || payload.iwant === 'Investment Sharing') && payload.property_sub_type === 'Hospitality') {
    let newpayload = {
      iwant: payload.iwant,
      property_name: payload.property_name,
      property_type: payload.property_type,
  ...
  if ((payload.iwant === 'Sell' || payload.iwant === 'Investment Sharing') && payload.property_sub_type === 'Shop_And_Retail') {
    let newpayload = {
      iwant: payload.iwant,
      property_name: payload.property_name,
      property_type: payload.property_type,
  ...
  if ((payload.iwant === 'Sell' || payload.iwant === 'Investment Sharing') && payload.property_sub_type === 'Educational') {
    let newpayload = {
      iwant: payload.iwant,
      property_name: payload.property_name,
      property_type: payload.property_type,
  ...
  if ((payload.iwant === 'Sell' || payload.iwant === 'Investment Sharing') && payload.property_sub_type === 'Office_Space') {
    let newpayload = {
      iwant: payload.iwant,
      property_name: payload.property_name,
      property_type: payload.property_type,
  ...
  if ((payload.iwant === 'Sell' || payload.iwant === 'Investment Sharing') && payload.property_sub_type === 'Industrial' && property_type !== 'Land or Plot') {
    let newpayload = {
      iwant: payload.iwant,
      property_name: payload.property_name,
      property_type: payload.property_type,
  ...
  if ((payload.iwant === 'Sell' || payload.iwant === 'Investment Sharing') && payload.property_type === 'Land or Plot') {
    let newpayload = {
      iwant: payload.iwant,
      property_name: payload.property_name,
      property_type: payload.property_type,
      ...
      rera_number: payload.rera_number,
      is_rera_verified: payload.is_rera_verified,
      dtcp_number: payload.dtcp_number,
  ...
  if (((payload.iwant === 'Rent' || payload.iwant === 'Property Sharing') || payload.iwant === 'Property Sharing') && payload.property_type === 'Residential') {
    let newpayload = {
      iwant: payload.iwant,
      property_name: payload.property_name,
      property_type: payload.property_type,
  ...
  if ((payload.iwant === 'Rent' || payload.iwant === 'Property Sharing') && payload.property_sub_type === 'Hospitality') {
    let newpayload = {
      iwant: payload.iwant,
      property_name: payload.property_name,
      property_type: payload.property_type,
  ...
  if ((payload.iwant === 'Rent' || payload.iwant === 'Property Sharing') && payload.property_sub_type === 'Shop_And_Retail') {
    let newpayload = {
      iwant: payload.iwant,
      property_name: payload.property_name,
      property_type: payload.property_type,
  ...
  if ((payload.iwant === 'Rent' || payload.iwant === 'Property Sharing') && payload.property_sub_type === 'Educational') {
    let newpayload = {
      iwant: payload.iwant,
      property_name: payload.property_name,
      property_type: payload.property_type,
  ...
  if ((payload.iwant === 'Rent' || payload.iwant === 'Property Sharing') && payload.property_sub_type === 'Office_Space') {
    let newpayload = {
      iwant: payload.iwant,
      property_name: payload.property_name,
      property_type: payload.property_type,
  ...
  if (
    (payload.iwant === 'Rent' || payload.iwant === 'Property Sharing') &&
  ...
  if ((payload.iwant === 'Rent' || payload.iwant === 'Property Sharing') && payload.property_type === 'Land or Plot') {
    let newpayload = {
      iwant: payload.iwant,
      property_name: payload.property_name,
      property_type: payload.property_type,
