...
import { LandFilterList } from '@/components/global/Common/Constant/filterList';
import FilterValues from '@/components/global/Common/FilterValues';
import LandRightFilter from '@/components/global/Land/LandRightFilter';
            ...
            <RNView>
              <RNView style={styles.rowContainer}>
                ...
                <RNView style={styles.rightView}>
                  <LandRightFilter active={activeKey} filterDetails={initialData} setFilterDetails={setFilterDetails} />
                </RNView>
              </RNView>
