...
const UserBusinessListCard: React.FC<Props> = ({ onPress, item, activeChat }) => {
        ...
        <RNView>
          {item?.connectedUsers?.profile_pic ? (
            ...
            <DefaultProfile
              ...
              username={item?.connectedUsers?.business_name}
            />
          )}
        </RNView>
        <RNView style={styles.leftSide}>
          <RNText style={styles.userName}>{item?.connectedUsers?.business_name}</RNText>
...
export default UserBusinessListCard;
